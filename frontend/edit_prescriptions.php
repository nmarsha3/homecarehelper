...
<body>
   <nav class="navbar navbar-inverse">
	...
	<div class="container-fluid">
		<div class="jumbotron">
            ...
            <br>
            <div class="col-sm-6">
			   Patient SSN: <input type="text" class="textbox" name="patient-ssn" id="patient-ssn"/>
            <br>
				</div>
            <div class="col-sm-6">
               Medicine: <input type="text" class="textbox" name="input-med" id="input-med"/>
            <br>
				</div>
            <div class="col-sm-6">
               Start Date: <input type="text" class="textbox" name="input-start-date" id="input-start-date"/>
            <br>
				</div>
            <div class="col-sm-6">
               End Date: <input type="text" class="textbox" name="input-end-date" id="input-end-date"/>
            <br>
				</div>
            <div class="col-sm-6">
               Times Taken: <input type="text" class="textbox" name="input-times-taken" id="input-times-taken"/>
            <br>
				</div>
            <div class="col-sm-6">
               Notes: <input type="text" class="textbox" name="input-notes" id="input-notes"/>
            <br>
				</div>
            <div class="col-sm-6">
   ...
   <script src="edit_prescriptions.js" type="text/javascript"></script>
