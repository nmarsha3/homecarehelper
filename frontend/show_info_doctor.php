   ...
   <nav class="navbar navbar-inverse">
	...
	<div class="container-fluid">
		<div class="jumbotron">
            ...
            <div class="col-sm-6">
                <p>Specialty: 
                    ...
                    <?php
                        ...
                        $stmt3 = mysqli_prepare($con, "select specialty from Doctor where ssn=?");
                        mysqli_stmt_bind_param($stmt3, "s", $ssn);
                        mysqli_stmt_execute($stmt3);
                        mysqli_stmt_bind_result($stmt3, $specialty);
            ...
            <div class="col-sm-6">
				<?php
						$ref_string = "<a href=edit_info_doctor.php?input_ssn=$ssn>".Edit."</a>";
						echo $ref_string;
				?>				
				</div>
