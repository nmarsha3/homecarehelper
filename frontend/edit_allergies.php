...
<body>
   <nav class="navbar navbar-inverse">
	...
	<div class="container-fluid">
		<div class="jumbotron">
            ...
            <div class="col-sm-6">
               Item: <input type="text" class="textbox" name="input-item" id="input-item"/>
            <br>
				</div>
            <div class="col-sm-6">
               Severity: <input type="text" class="textbox" name="input-severity" id="input-severity"/>
            <br>
				</div>
            <div class="col-sm-6">
   ...
   <script src="edit_allergies.js" type="text/javascript"></script>
